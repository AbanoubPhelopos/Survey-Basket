...
public static class VoteErrors
{
    ...
    public static readonly Error VoteIdentityAlreadyExists = new("Vote.IdentityAlreadyExists", "This email or mobile has already submitted a response for this survey.", StatusCodes.Status409Conflict);
