...
namespace Survey_Basket.Infrastructure.Migrations
{
    ...
    [Migration("20260302152529_AddCompanyPollAccessLinksTable")]
    partial class AddCompanyPollAccessLinksTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<System.Guid>", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            ClaimType = "permissions",
                            ClaimValue = "polls:read",
                            RoleId = new Guid("0299fd4b-3c1f-7eab-84c4-47f5aad20c87")
                        },
                        new
                        {
                            Id = 37,
            ...
            modelBuilder.Entity("Survey_Basket.Domain.Entities.ApplicationRole", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = new Guid("0399fd4b-3c1f-7eab-84c4-47f5aad20c88"),
                            ConcurrencyStamp = "3399fd50-a461-715e-ae9c-ddf7d6ea249f",
                            IsDefault = false,
                            IsDeleted = false,
                            Name = "SystemAdmin",
                        ...
                        new
                        {
                            Id = new Guid("0499fd4b-3c1f-7eab-84c4-47f5aad20c89"),
                            ConcurrencyStamp = "4499fd50-a461-715e-ae9c-ddf7d6ea249f",
                            IsDefault = false,
                            IsDeleted = false,
                            Name = "PartnerCompany",
                            NormalizedName = "PARTNERCOMPANY"
                        },
                        new
                        {
                            Id = new Guid("0599fd4b-3c1f-7eab-84c4-47f5aad20c8a"),
                            ConcurrencyStamp = "5599fd50-a461-715e-ae9c-ddf7d6ea249f",
                            IsDefault = false,
                            IsDeleted = false,
                            Name = "CompanyUser",
            ...
            modelBuilder.Entity("Survey_Basket.Domain.Entities.Company", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Survey_Basket.Domain.Entities.CompanyPollAccessLink", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("CompanyPollAccessLinks");
                });
            ...
            modelBuilder.Entity("Survey_Basket.Domain.Entities.PollAudience", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("PollId", "CompanyId")
                        .IsUnique();

                    b.ToTable("PollAudiences");
                });

            modelBuilder.Entity("Survey_Basket.Domain.Entities.PollOwner", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Survey_Basket.Domain.Entities.Poll", b =>
                {
                    ...
                    b.HasOne("Survey_Basket.Domain.Entities.Company", "OwnerCompany")
                        .WithMany("OwnedPolls")
            ...
            modelBuilder.Entity("Survey_Basket.Domain.Entities.Company", b =>
                {
                    ...
                    b.Navigation("PollOwners");

                    b.Navigation("TargetedPolls");
